...
const HeroSection = () => {
  return (
    <section className="container items-center relative flex flex-col-reverse gap-8 lg:flex-row hero">
      <div className="lg:w-1/2 lg:static absolute top-[50%] translate-y-[-50%] lg:translate-y-0">
        <div className="relative w-fit mx-auto lg:mx-0">
          <h1 className="font-semibold lg:translate-y-[-50%] translate-y-[40%]">
            Product Designer
          </h1>
          <div className="relative z-10">
            <h3 className="text-2xl translate-y-4 font-semibold text-center lg:text-start">
              Hello, it&apos;s me
            </h3>
            <h2 className="flex items-center gap-1 text-8xl font-semibold ">
              Ojieame
              <span className="block  w-4 h-4 rounded-full bg-mainBg"></span>
            </h2>
          </div>
        </div>
        <p className="text-fade px-4 sm:text-lg text-justify relative z-10">
